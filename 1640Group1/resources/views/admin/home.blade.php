...
<div class="login-container">
    <div class="row g-0">
        ...
        <div class="col-md-6 login-form-section">
            ...
            <div class="menu-list">
                <a href="/accounts" class="home-menu-item">
                ...
                <a href="/create-user" class="home-menu-item">
                ...
                <a href="/settings" class="home-menu-item">
            ...
            <div class="text-center">
                <a href="/logout" class="btn-logout d-inline-block">
