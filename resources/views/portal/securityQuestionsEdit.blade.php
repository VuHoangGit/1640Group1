        ...
        <div class="auth-card">
            <div class="row g-0 auth-row">
                <div class="col-lg-6 auth-visual">
                    <a href="{{ $cancelUrl }}" class="back-button" title="Back">
                    ...
                    <div class="visual-brand">
                        ...
                        <h1 class="visual-title">{{ $isFirstSetup ? 'Set up your security question for account protection' : 'Update your security question and answer securely' }}</h1>
                        <p class="visual-desc">
                            {{ $isFirstSetup ? 'Choose a security question and save an answer to improve your account security from the start.' : 'Select the question you want to update and save your new answer to keep your account details current.' }}
                        </p>
                    </div>

                    <div class="visual-illustration-wrap">
                        <img src="https://cdni.iconscout.com/illustration/premium/thumb/forgot-password-4268397-3551717.png" alt="Edit Security Questions" class="visual-illustration">
                    </div>
                </div>
                ...
                <div class="col-lg-6 auth-form">
                    ...
                    <div class="mb-4">
                        <h2 class="auth-title">{{ $isFirstSetup ? 'Set Up Security Question' : 'Update Security Question' }}</h2>
                        <p class="auth-subtitle">Logged in as <strong>{{ Auth::user()->email }}</strong></p>
                        <p class="auth-subtitle">{{ $isFirstSetup ? 'Choose a security question and set your answer.' : 'Choose which question to update and enter the new answer.' }}</p>
                    </div>

                    @if(session('info'))
                        <div class="alert alert-info py-3 mb-3" role="alert">
                            {{ session('info') }}
                        </div>
                    @endif
                    ...
                    <form action="{{ route('updateSecurityQuestions') }}" method="POST">
                        ...
                        <div class="form-group">
                            <label class="form-label-custom">Select question</label>
                            <select
                        ...
                        <div class="form-group">
                            <label class="form-label-custom">New answer</label>
                            <input
                                type="text"
                                name="new_answer"
                                value="{{ old('new_answer') }}"
                                class="form-control @error('new_answer') is-invalid @enderror"
                                required
                            >
                        </div>

                        <button type="submit" class="btn-submit">{{ $isFirstSetup ? 'Save Security Question' : 'Save Changes' }}</button>
