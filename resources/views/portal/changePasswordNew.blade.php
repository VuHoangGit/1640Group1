        ...
        <div class="auth-card">
            <div class="row g-0 auth-row">
                <div class="col-lg-6 auth-visual">
                    <a href="{{ route('changePassword') }}" class="back-button" title="Back">
                    ...
                    <div class="visual-brand">
                        ...
                        <h1 class="visual-title">Create a strong new password for your account</h1>
                        <p class="visual-desc">
                            Your new password must be secure and easy for you to remember, while keeping your account protected.
                        </p>
                    </div>

                    <div class="visual-illustration-wrap">
                        <img
                            src="https://cdni.iconscout.com/illustration/premium/thumb/forgot-password-4268397-3551717.png"
                ...
                <div class="col-lg-6 auth-form">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="auth-subtitle">Your new password must be at least 5 characters.</p>
                    </div>
