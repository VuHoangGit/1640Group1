        ...
        <div class="auth-card">
            <div class="row g-0 auth-row">
                <div class="col-lg-6 auth-visual">
                    <a href="{{ route('loginPage') }}" class="back-button" title="Back">
                    ...
                    <div class="visual-brand">
                        ...
                        <h1 class="visual-title">Recover access to your account safely</h1>
                        <p class="visual-desc">
                            Enter your email, choose the correct security question, and verify your identity to continue.
                        </p>
                    </div>
                ...
                <div class="col-lg-6 auth-form">
                    ...
                    <div class="mb-4">
                        <h2 class="auth-title">Retrieve password</h2>
                        <p class="auth-subtitle">Enter your email and verify your identity to reset your password.</p>
                    </div>
