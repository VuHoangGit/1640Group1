        ...
        <div class="auth-card">
            <div class="row g-0 auth-row">
                <div class="col-lg-6 auth-visual">
                    <a href="{{ $dashboardUrl }}" class="back-button">
                    ...
                    <div class="visual-brand">
                        ...
                        <h1 class="visual-title">Verify your identity before managing security questions</h1>
                        <p class="visual-desc">
                            Answer one of your security questions correctly before continuing to update your account protection settings.
                        </p>
                    </div>

                    <div class="visual-illustration-wrap">
                        <img src="https://cdni.iconscout.com/illustration/premium/thumb/forgot-password-mobile-4268413-3551733.png" alt="Security Questions Illustration" class="visual-illustration">
                    </div>
                </div>
                ...
                <div class="col-lg-6 auth-form">
                    ...
                    <div class="mb-4">
                        <h2 class="auth-title">Manage Security Questions</h2>
                        <p class="auth-subtitle">Logged in as <strong>{{ Auth::user()->email }}</strong></p>
                        <p class="auth-subtitle">Verify your identity first by answering one of your security questions.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('verifySecurityQuestion') }}">
                        ...
                        <div class="form-group">
                            <label class="form-label-custom">Choose a question to verify</label>
                            <select
